    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btnmanghinhsang30s:
                SharedPreferences_Utils.setScreenTimeOutReadStory(TextSize.THIRTY_SECOUND);
            ...
            case R.id.btnmanghinhsang1p:
                SharedPreferences_Utils.setScreenTimeOutReadStory(TextSize.ONE_MINUTE);
            ...
            case R.id.btnmanghinhsang10phut:
                SharedPreferences_Utils.setScreenTimeOutReadStory(TextSize.TEN_MINUTE);
